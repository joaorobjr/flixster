...
```{r users-ratings, fig.align= "center", fig.cap= "\\label{users-ratings}Histogram of the number of ratings. Approximatelly 68.3% of the users rated 10 films or less."}
flixster %>%
  group_by(userid) %>% 
  summarise(n= n()) %>% 
ggplot() +
